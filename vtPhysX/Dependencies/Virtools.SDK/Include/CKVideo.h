...
typedef struct CKVideoInfo
{
	...
	XString		m_VideoFormat;		// Readible Video Format (Compression)
	...
	XString		m_AudioFormat;		// Readible Sound Format (Compression)
...
typedef enum CK_SAVEVERSION_VIDEO
{
	...
	CK_SAVEVERSION_VIDEO2		= 2,	// Reserved for future use
