...
//typedef function ptr
	...
	typedef BOOL (*GetLatestVersionFunc)				(const char* sFile,BOOL references);
	...
	typedef NODE_TYPE (*IsNodeInDatabaseFunc)			(const char* sFile,CHECKOUT_TYPE *oCheckOut);
	...
	typedef BOOL (*AddSourceControlMenuToFunc)			(CMenu* menu,const char* path,int startingCommandID,int* endingCommandID,MENU_FLAGS flags);
